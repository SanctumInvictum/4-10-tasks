...
public class Main {
    ...
    public static StringBuilder toStarShorthand(String line) {
        // Создадим выводимую изменяемую строку
        StringBuilder NewLine = new StringBuilder();
        line += " ";
        //записываем первый символ в изменяемую строку
        char last = line.charAt(0);
        int count = 1;
        // зададим счетчик по длинне строки
        for (int i = 1; i < line.length(); i++) {
            //Если символ равен предыдущему, увеличиваем счётчик, если нет, то
            // либо добавляем значение с учетом преобразования, либо просто значение в выводимую строку
            ...
            // при любых условиях предыдущий символ приравнивается к текущему
            last = a;
        }
        return NewLine;
    }
    ...
    public static boolean doesRhyme(String firstLine, String secondLine) {
        // Находим только гласные в обоих последних словах. Порядок гласных учитываем
        ...
        // Возвращаем результат сравнения двух строк состоящих из гласных последних слов
        return word2.equals(word1);
    }

    // №9: Функция, которая принимает два целых числа и возвращает true, если число повторяется три раза подряд в любом
    // месте в num1 и то же самое число повторяется два раза подряд в num2
    ...
    // №10: Функция, которая возвращает общее кол-во уникальных символов(книг) между всеми парами концов книги,
    // если пара одинаковых символов служит концами книги для всех символов между ними
